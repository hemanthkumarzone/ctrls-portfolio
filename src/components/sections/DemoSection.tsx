...
export default function DemoSection() {
  ...
  return (
    <section id="demo" className="w-full flex justify-center">
      ...
      {/* DESKTOP */}
      <div
        className="hidden lg:block relative w-[1728px] h-[700px] border-[8px] border-transparent"
        style={{ borderImage: "linear-gradient(180deg,#283E00,#182500) 1" }}
      >

        <div className="absolute left-[77px] top-[100px]">
          <p
        ...
        <div className="absolute left-[74px] top-[180px] w-[695px]">
          <h1
  className="text-[#77B900] text-[52px] font-semibold leading-[80px]"
  dangerouslySetInnerHTML={{ __html: demo.title as string }}
/>
        </div>

        <div className="absolute left-[77px] top-[480px] w-[704px]">
          <div
...
/>
        ...
        {/* FORM */}
        <div className="absolute left-[791px] top-[120px]">

          <div className="w-[400px] rounded-[30px] border-2 border-[#283E00] p-[20px]">

            <h2 className="text-white text-[30px] mb-[16px]">
              {demo.form.title}
            </h2>
            ...
            {[
              ...
              <div key={i} className="mb-[12px]">
                ...
                <input
                  ...
                  className="w-full h-[45px] bg-[#0F180F] border border-[#2E5A00] rounded-[18px] mt-[4px] px-[18px] text-white placeholder-gray-400 outline-none focus:outline-none focus:ring-2 focus:ring-[#77B900] focus:border-[#77B900]"
            ...
            <div className="flex justify-end">
              <button
                ...
                className="w-[126px] h-[38px] bg-[#77B900] rounded-[11px] text-black text-[20px]"
              >
