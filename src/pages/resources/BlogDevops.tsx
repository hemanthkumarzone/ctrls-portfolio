...
const BlogDevops = () => {
  ...
  <div className="relative max-w-[1200px] mx-auto px-6 py-4">
    ...
    <p className="text-[#D9D9D9] text-[18px] leading-[1.6] max-w-[800px]">
        Explore new Savings Insights for Resource Quotas, with recommendations to right-size and actions to create or update quotas.tomation.
  ...
  <div className="relative">
    ...
    <ul className="space-y-3 text-[#A3A3A3] text-[13px]">
      <li>IBM Kubecost 3.1: Kubernetes Resource Quota Rightsizing</li>
      <li>What’s New in 3.1: Kubernetes Resource Quota Rightsizing</li>
      <li>Quick Refresher: What Resource Quotas Do</li>
      <li>Walkthrough: Right-Size Quotas from Insights Card to Apply</li>
      <li>Getting Started with 3.1</li>
    </ul>
